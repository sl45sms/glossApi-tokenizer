...
The visualizer takes one sentence or a set of sentences and compares the tokenization results from two tokenizers, reporting differences in token counts, average characters per token, and example tokenizations.
...
You can override both paths from the UI.

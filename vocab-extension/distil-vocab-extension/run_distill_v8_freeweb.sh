...
./run_uenv.sh python -u ${PROJECT_DIR}/vocab-extension/distil-vocab-extension/advanced_withfreeweb_token_init.py \
  ...
  --output-dir "${SCRATCH}/apertus-greek-tokenizer-distill-freeweb" \

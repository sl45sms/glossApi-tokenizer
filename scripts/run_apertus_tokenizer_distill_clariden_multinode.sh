...
MAX_TRAINABLE_TOKENS="${MAX_TRAINABLE_TOKENS:-1500}"
UNTIED_OUTPUT_INIT_STRATEGY="${UNTIED_OUTPUT_INIT_STRATEGY:-zero}"
TRAIN_UNTIED_OUTPUT_ROWS="${TRAIN_UNTIED_OUTPUT_ROWS:-0}"
...
SRUN_EXPORT+=",MAX_TRAINABLE_TOKENS=${MAX_TRAINABLE_TOKENS}"
SRUN_EXPORT+=",UNTIED_OUTPUT_INIT_STRATEGY=${UNTIED_OUTPUT_INIT_STRATEGY}"
SRUN_EXPORT+=",TRAIN_UNTIED_OUTPUT_ROWS=${TRAIN_UNTIED_OUTPUT_ROWS}"
...
common_args=(
	...
	--max-trainable-tokens "${MAX_TRAINABLE_TOKENS}"
	--untied-output-init-strategy "${UNTIED_OUTPUT_INIT_STRATEGY}"
...
if [[ "${TRAIN_UNTIED_OUTPUT_ROWS}" == "1" ]]; then
	common_args+=(--train-untied-output-rows)
else
	common_args+=(--no-train-untied-output-rows)
fi
